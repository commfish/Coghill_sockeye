...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE, 
                      ...
                      tidy=TRUE)
library(tidyverse)
library(gsl)  #This library need for Lamber's W method to calculate Smsy.
...
ggsave("figures/ChilkootSR.png", dpi = 300)
```
...
ggplot(Chilkoot, aes(Spawn, Recruit))+
  ...
  annotate("text", x=Smsy, y=msy.r, label="Maximum Yield", vjust=-1.2,hjust=-.1, color=4)+ #label 'Lambert' Smsy
